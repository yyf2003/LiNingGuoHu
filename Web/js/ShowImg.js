...
window.ShowImg = function(strLeft,strTop,strWidth,strHeight,imgHeight,strTitle,url)
{
	...
	strHtml += "    <li><div class=\"hir1\"></div><div class=\"hirimg\"><img src=\"../../images/state3.gif\" style=\"cursor:pointer;\" alt=\"关闭\" onclick=\"doOk();\" /></div></li>\n";
	strHtml += "    <li class=\"hir2\" style='height:250px; margin-left:-1px'><img src='"+url+"'  width=\""+strWidth+"\" height=\""+imgHeight+"\"/></li>\n";
