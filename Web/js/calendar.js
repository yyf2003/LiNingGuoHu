...
document.writeln('<iframe bgcolor="#000000" id=meizzDateLayer Author=wayx frameborder=0 style="position: absolute; z-index: 9998; display: none" width=186 height=247></iframe>');
strFrame='<style>';
...
strFrame+='      <tr align=center Author="wayx"><td width=16 align=center bgcolor=#B6CAE4 style="font-size:12px;cursor:pointer;color: #ffffff" ';
...
strFrame+=' BORDERCOLORLIGHT=#3677b1 BORDERCOLORDARK=#FFFFFF width="100%" height=25 Author="wayx" style="cursor:' + (bMoveable ? 'move':'default') + '">';
...
strFrame+='        <td colspan=3 align=right Author=meizz><span onclick=parent.closeLayer() style="font-size:12px;cursor:pointer"';
...
strFrame+='             onfocus="this.blur()" style="font-size: 12px; height: 20px;cursor:pointer"><input Author=meizz class=button title="向前翻 1 月" type=button ';
strFrame+='             value="< " onclick="parent.meizzPrevM()" onfocus="this.blur()" style="font-size: 12px; height: 20px;cursor:pointer"></td><td ';
...
strFrame+='             onfocus="this.blur()" title="向后翻 1 月" style="font-size: 12px; height: 20px;cursor:pointer"><input ';
strFrame+='             Author=meizz type=button class=button value=">>" title="向后翻 1 年" onclick="parent.meizzNextY()"';
strFrame+='             onfocus="this.blur()" style="font-size: 12px; height: 20px;cursor:pointer"></td>';
