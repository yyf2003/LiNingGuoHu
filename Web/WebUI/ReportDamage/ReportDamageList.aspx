<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportDamageList.aspx.cs"
    Inherits="WebUI_ReportDamage_ReportDamageList" %>
...
<body >
    <form id="form1" runat="server">
        ...
        <div style="width: 100%; margin-top: 3px;" class="table">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" Width="100%" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="25">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="查看">
                        <ItemTemplate>
                            <a href="ShowReportDamage.aspx?ShopID=<%#Eval("ShopID") %>">查看</a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="25%" />
                        <HeaderStyle Width="25%" />
                    </asp:TemplateField>
