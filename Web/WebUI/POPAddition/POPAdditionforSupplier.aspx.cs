...
public partial class WebUI_POPAddition_POPAdditionforSupplier : System.Web.UI.Page
{
    ...
    protected string POPAddtionCount = string.Empty;
    protected string POPAddtitionArea = string.Empty;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        LoginUserID = this.Request.Cookies["UserID"].Value;
    ...
    {
        DataSet ds = new LN.BLL.POPAddition().GetPOPAdditionList(shopid);
        double dd = 0.000;
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            {
                dd += double.Parse((dr["POPArea"].ToString()));
            }
            POPAddtitionArea = dd.ToString();
            POPAddtionCount = dt.Rows.Count.ToString();
