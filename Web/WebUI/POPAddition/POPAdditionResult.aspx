<%@ Page Language="C#" AutoEventWireup="true" CodeFile="POPAdditionResult.aspx.cs"
    Inherits="WebUI_POPAddition_POPAdditionResult" %>
                ...
                <asp:Repeater runat="server" ID="RepPOPList">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="center">
                                <%#Eval("ExamState").ToString() == "0" ? "未审核" : Eval("ExamState").ToString() == "1" ? "<font color=red>已审核</font>" : "<font color=red>审核未通过</font>"%>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
