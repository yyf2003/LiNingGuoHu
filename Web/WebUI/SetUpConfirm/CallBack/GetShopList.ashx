...
public class GetShopList : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        //一级客户编号
        string DealerID = context.Request["did"] == null ? "0" : context.Request["did"].ToString();
        //直属客户编号
        string FXID = context.Request["fid"] == null ? "" : context.Request["fid"].ToString();
        //直属客户名称    
        string FXName = context.Request["fname"] == null ? "0" : context.Request["fname"].ToString();
        ...
        DataTable dt = new LN.BLL.ShippingSpeedData().GetConfirmShopListByDealerID(DealerID, FXID, ShopID, ShopName, order, Int32.Parse(pageSize), pageindex, ref TotleNumber);
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            sb.Append("{SNumberID:\"0\",POPID:\"\",ShopID:\"\",PosID:\"\",FXID:\"\",Shopname:\"暂无店铺\",SupplierID:\"\",Boolinstall:\"\",TotleNumber:\"0\"}");
