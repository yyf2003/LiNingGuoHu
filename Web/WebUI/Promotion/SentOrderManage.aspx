<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SentOrderManage.aspx.cs"
    Inherits="WebUI_Promotion_SentOrderManage" %>
        ...
        >
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <a href="PromotionShops.aspx?id=<%#Eval("Id") %>&isSent=1">查看</a>
                    </td>
