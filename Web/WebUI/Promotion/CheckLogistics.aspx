<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckLogistics.aspx.cs" Inherits="WebUI_Promotion_CheckLogistics" %>
       ...
       <div style="font-size: 14px; font-weight: bold; text-align: left; padding-left: 20px;
        ...
        <table class="table">
            <tr>
                ...
                <td>
                    <asp:Label ID="labSentDate" runat="server" Text=""></asp:Label>
                </td>
            ...
            <tr>
                ...
                <td>
                  <asp:Label ID="labWuLiuDan" runat="server" Text=""></asp:Label>
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="labSentRemark" runat="server" Text=""></asp:Label>
                </td>
            ...
            <tr>
                ...
                <td>
                   <asp:Label ID="labReceiveDate" runat="server" Text=""></asp:Label>
                </td>
            ...
            <tr>
                ...
                <td>
                  <asp:Label ID="labQianShouDan" runat="server" Text=""></asp:Label>
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="labReceiveRemark" runat="server" Text=""></asp:Label>
                </td>
