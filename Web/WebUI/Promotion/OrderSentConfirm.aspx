<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderSentConfirm.aspx.cs"
    Inherits="WebUI_Promotion_OrderSentConfirm" %>
    ...
    <div style="width: 95%">
        ...
        <table class="table">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtSentDate" MaxLength="10" runat="server" ContentEditable="false" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"
