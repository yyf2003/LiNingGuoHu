<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SetRackLimitCount1.aspx.cs" Inherits="WebUI_Promotion_RackInfo_SetRackLimitCount1" %>
            ...
            <ItemTemplate>
                <tr>
                    <td style="width: 100px;">
                        ...
                        <asp:HiddenField ID="hfShopType" runat="server" Value='<%#(string)Container.DataItem %>' />
                    </td>
