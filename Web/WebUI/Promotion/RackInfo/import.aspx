<%@ Page Language="C#" AutoEventWireup="true" CodeFile="import.aspx.cs" Inherits="WebUI_Promotion_RackInfo_import" %>
...
<body>
        ...
        <tr>
            ...
            <td style="text-align: left;">
                <div id="showButton" runat="server">
                    <asp:Button ID="Button_ImportProp" runat="server" Text=" 导 入 " CssClass="qr0" 
                        OnClientClick="return checkFile()" onclick="Button_ImportProp_Click" />
                    &nbsp;&nbsp;
    ...
    <div style=" margin-top:30px; text-align:center;">
        <asp:Button ID="btnBack" runat="server" Text="返 回" CssClass="qr0" 
