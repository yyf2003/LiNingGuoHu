<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShopOrderformPreview.aspx.cs"
    Inherits="WebUI_Shopmanage_ShopOrderformPreview" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript" src="javascript/GetShopOrderformPreview.js"></script>
    ...
    <script language="javascript" type="text/javascript">
        ...
        //add by mhj 2012.3.27
        function setstate() {
            if (document.getElementById("h_supplierId").value != "0") {
                document.getElementById("<%=DDL_department.ClientID%>").setAttribute("disabled", "disabled");
                document.getElementById("<%=DDL_Area.ClientID%>").setAttribute("disabled", "disabled");
                if ($("#ddl_specialType").val() == "1") {
                    //document.getElementById("h_supplierId").value = "0";
                    document.getElementById("<%=DDL_department.ClientID%>").setAttribute("disabled", "");
                    document.getElementById("<%=DDL_Area.ClientID%>").setAttribute("disabled", "");
                }
                else {
...
<body>
    ...
    <input type="hidden" id="h_supplierId" value="0" runat="server" />
    <div style="width: 90%; position: relative;">
        ...
        <table class="table" style="margin-top: 20px; margin-left: 5%">
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DDL_POPID" runat="server" onchange="ChangePOPID()">
            ...
            <tr>
                ...
                <td style="width: 30%;">
                    &nbsp;
                    <asp:DropDownList ID="ddl_specialType" onchange="setstate()" runat="server" CssClass="txtwith">
                        <asp:ListItem Value="-1">全部</asp:ListItem>
                        <asp:ListItem Value="0">普通店</asp:ListItem>
                        <asp:ListItem Value="1">标杆店</asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td style="width: 15%; text-align: left">
                </td>
