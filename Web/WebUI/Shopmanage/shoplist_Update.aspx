<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shoplist_Update.aspx.cs"
    Inherits="WebUI_Shopmanage_shoplist_Update" %>
    ...
    <div style="width: 90%; position: relative;">
        ...
        <table class="table" style="margin-top: 20px; margin-left: 5%">
            ...
            <tr>
                ...
                <td style="width: 30%;">
                    &nbsp;
                    <asp:DropDownList ID="ddl_specialType" runat="server" CssClass="txtwith">
