<%@ WebHandler Language="C#" Class="GetShopList_Del" %>
...
using System.Data;
public class GetShopList_Del : IHttpHandler
{

    public void ProcessRequest(HttpContext context)
    {
        context.Response.ContentType = "text/plain";
        LN.Model.POPLaunch pl = new LN.BLL.POPLaunch().GetNewestModel();
        DateTime dtTime = DateTime.Now;
        DataTable dt = null;
        StringBuilder sb = new StringBuilder();
        sb.Append("[");
        string str = "当前没有发起POP";
        if (pl != null && dtTime >= pl.BeginDate && dtTime <= pl.EndDate)
        {
            str = "没有你所要的店铺！";
            ...
            dt = BLL.GetInfolist(hdt, ref TotalNumber);
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                else
                {
                    ...
                    sb.Append("<a href='javascript:DelPOP(" + dt.Rows[i]["ShopID"].ToString() + ")'>初始化</a>");
