<%@ WebHandler Language="C#" Class="GetShopOrderformPreview" %>
...
using System.Data;
public class GetShopOrderformPreview : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        string department = context.Request.QueryString["dept"] != null ? context.Request.QueryString["dept"].ToString() : "0";
        string AreaID = context.Request.QueryString["areaid"] != null ? context.Request.QueryString["areaid"].ToString() : "0";
        string POPID = context.Request.QueryString["popID"] != null ? context.Request.QueryString["popID"].ToString() : "";

        //add by mhj 2012.2.5
        string supplierId = context.Request.QueryString["supplierId"] != null ? context.Request.QueryString["supplierId"].ToString() : "0";
        string specialType = context.Request.QueryString["specialType"] != null ? context.Request.QueryString["specialType"].ToString() : "-1";
        ...
        hdt.Add("specialType", specialType);
        ...
        DataTable dt = BLL.GetShopInfoByPOPIDAndShopID(hdt, ref TotalNumber);
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            if (dt.Rows[i]["ShopState"].ToString() == "闭店")
            {
                sb.Append("\",");
                sb.Append("xg");//修改
                sb.Append(":\"");
            ...
            else
            {
                ...
                sb.Append("<a href='javascript:GetShopOrderformDetail(" + dt.Rows[i]["ShopID"].ToString() + ")'>订单查询</a>");
                //sb.Append("<a href=\"javascript:DelPOP(\"" + dt.Rows[i]["ShopID"].ToString() + "\")\">删 除</a>");
                sb.Append("\",");

            }
            sb.Append("gd");//关店
            sb.Append(":\"");
            sb.Append(dt.Rows[i]["ShopState"].ToString());
            sb.Append("\"},");
        }
        if (dt.Rows.Count <= 0)
        {
