<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateMaterialPrice.aspx.cs" Inherits="WebUI_Supplier_UpdateMaterialPrice" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>修改供应商材料价格</title>
...
<div style="width:100%; height:auto; text-align:center">
    <div style=" font-size:14px; font-weight:bold; text-align:left; padding-left:20px; width:50%;float:left; height:30px;color: #c86000;">修改材料报价</div>
