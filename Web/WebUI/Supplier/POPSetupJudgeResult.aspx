<%@ Page Language="C#" AutoEventWireup="true" CodeFile="POPSetupJudgeResult.aspx.cs" Inherits="WebUI_Supplier_POPSetupJudgeResult" %>
...
<head>
	...
	<script language="javascript" type="text/javascript" src="./javascript/ShowPOPImgJudgeResult.js"></script>
...
<div style="width:90%">
		...
		<table class="table" style="margin-top:20px; margin-left:5%">
			...
			<tr>
				...
				<td style="width:30%;">
					&nbsp;<asp:DropDownList ID="DDL_POP" CssClass="txtwith" runat="server" onchange="GetcityList()">
                    </asp:DropDownList></td>
			...
			<tr>
				...
				<td style="width:15%;text-align:right">地级城市：</td>
			...
			<tr>
				...
				<td style="width:30%;">
					<asp:DropDownList ID="DDL_JudgeState" CssClass="txtwith" runat="server">
						<asp:ListItem Value="-1">请选择审核状态</asp:ListItem>
						<asp:ListItem Value="0">未审核</asp:ListItem>
						<asp:ListItem Value="1">已审核</asp:ListItem>
					</asp:DropDownList></td>
				<td style="width: 15%;text-align:right"></td>
				<td style="text-align:center;"><input id="Btn_search" type="button"  class="qr0" value="查 询"  onclick="ShowPOPImgJudgeResult(1)"/></td>
			</tr>
		</table>
