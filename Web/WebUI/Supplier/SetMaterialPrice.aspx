<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SetMaterialPrice.aspx.cs" Inherits="WebUI_Supplier_SetMaterialPrice" %>
...
<div style="width:90%; text-align:center">
	...
	<div id="showMateriaList" style="width:900px; border:1px solid #6d6060; margin-top:20px; float:left; margin-left:5%">
	    <div style="width:100%; height:30px; font-size:12px; text-align:left; font-weight:bold; margin-top:10px; margin-left:10px;">材料报价
	    	<span style="color:red; float:right; margin-right:20px; margin-top:-10px;">注意：未使用到的材料的价格可以设置为 0</span>
	    </div>
	    <asp:Repeater id="RepMateriaPrice" runat="server">
	    <ItemTemplate>
	    <div class="show">
	        <asp:Label id="lblID" Text='<%# Eval("MateriaID") %>' runat="server" Visible="false"></asp:Label>
	        <%# Eval("MateriaPro") %>：<asp:TextBox ID="txtPrice" Width="20%" runat="server" Text='<%# Eval("POPPrice") %>' onclick="this.select();" ></asp:TextBox>
	    </div>
	    </ItemTemplate>
	    </asp:Repeater>
	    <br /><br /><br />
