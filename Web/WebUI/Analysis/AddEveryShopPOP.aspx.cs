...
public partial class WebUI_Analysis_AddEveryShopPOP : System.Web.UI.Page
{
    string shopid = string.Empty, POPID = string.Empty;
    ...
    private void bind()
    {
       DataSet ds= new LN.BLL.POPAddition().GetAddEveryPOPlist(shopid,POPID);
