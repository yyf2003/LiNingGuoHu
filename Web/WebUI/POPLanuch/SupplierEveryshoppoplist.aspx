<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SupplierEveryshoppoplist.aspx.cs" Inherits="WebUI_POPLanuch_SupplierEveryshoppoplist" %>
...
<tr>
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="产品大类" DataField="ProductTypeName" >
                <ItemStyle Width="150px" />
            </asp:BoundField>
            <asp:BoundField HeaderText="产品系列" DataField="ProductLine" >
