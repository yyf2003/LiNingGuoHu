<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SendToDealer.aspx.cs" Inherits="WebUI_PhysicalDistribution_SendToDealer" %>
                ...
                <asp:Repeater runat="server" ID="RepShopList" OnItemDataBound="RepShopList_ItemDataBound">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="">
                                <asp:CheckBox ID="chkSelect" runat="server" Checked="false" onclick="AddOrDeleteIDBy(this,'')" /></td>
                            <%--<%# DataBinding.Eval(Container.DataBinding,"", "ShopID")%>--%>
