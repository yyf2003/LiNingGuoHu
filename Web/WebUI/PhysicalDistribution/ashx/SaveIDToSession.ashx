<%@ WebHandler Language="C#" Class="SaveIDToSession" %>
...
public class SaveIDToSession : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        IDictionary<string, ArrayList> di = context.Session["ToDealer"] == null ? new Dictionary<string, ArrayList>() : context.Session["ToDealer"] as Dictionary<string, ArrayList>;
        if (isAdd == "")
        {
