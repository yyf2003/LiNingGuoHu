<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SendToShop.aspx.cs" Inherits="WebUI_PhysicalDistribution_SendToShop" %>
    ...
    <form id="form1" runat="server">
        <div style="width: 100%; height: auto; text-align: center">
            <div style="font-size: 14px; font-weight: bold; text-align: left; padding-left: 20px;
                ...
                <a href="SendToShopList.aspx" title="发货到店铺" style="color: #c86000;">发货到店铺</a> &gt;&gt;
                <%= ShopName%>
            </div>
