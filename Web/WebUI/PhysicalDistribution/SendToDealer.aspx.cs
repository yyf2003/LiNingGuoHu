...
using System.Text;
public partial class WebUI_PhysicalDistribution_SendToDealer : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //FXID = Request.QueryString["FXID"] == null ? "" : Request.QueryString["FXID"].ToString();
    ...
    public void RepShopList_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            IDictionary<string, ArrayList> di = Session["ToDealer"] == null ? new Dictionary<string, ArrayList>() : Session["ToDealer"] as Dictionary<string, ArrayList>;
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        if (strList.Count > 0)
        {
            ...
            if (result > 0)
            {
                Session["ToDealer"] = null;
                GetList();
                Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "_erro", "<script>alert('提交发货单成功！！');window.location='DistributorsInfoList.aspx?DealerID=" + DealerID + "';</script>");
