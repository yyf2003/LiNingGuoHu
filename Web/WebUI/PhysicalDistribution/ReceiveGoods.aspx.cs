...
public partial class WebUI_PhysicalDistribution_ReceiveGoods : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            {
                Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "alert", "<script>alert('没有您负责的一级客户，请联系管理员');window.location.href='../Affiche/Index.aspx'</script>");
            }
    ...
    private void GetList()
    {
        ...
        StrWhere += " and GetInState<>'已收货' and IsState='发货到一级客户' and popid in (SELECT POPID FROM POPLaunch WHERE BeginDate<=getdate() and EndDate>=getdate())";
