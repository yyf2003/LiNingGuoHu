<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SendToShopList.aspx.cs" Inherits="WebUI_PhysicalDistribution_SendToShopList" %>
                ...
                <asp:Repeater runat="server" ID="RepShopList">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="">
                                <a href='SendToShop.aspx?id=<%# Eval("ShopID")%>&sid=<%= hidSupplierID.Value %>&did=<%# Eval("DealerID")%>&fxid=<%#Eval("FXID") %>'>
                                    发货</a></td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
