<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shopRecevieGoods.aspx.cs" Inherits="WebUI_PhysicalDistribution_shopRecevieGoods" %>
...
<body >
    ...
    <table class="table">
			...
			<tr>
				<td style="width:15%;">
                    发货单号：</td>
				<td style="width:30%;">&nbsp;<asp:DropDownList ID="txt_FHID" runat="server" CssClass="txtwith">
                    </asp:DropDownList></td>
			...
			<td>直属客户：</td><td><asp:DropDownList ID="DDL_fx" runat="server">
                        ...
                        </asp:DropDownList></td><td>一级客户：</td><td><asp:DropDownList ID="ddl_dealer" CssClass="txtwith" onchange="GetFxlist()" runat="server"></asp:DropDownList></td>
			</tr>
			<tr>
